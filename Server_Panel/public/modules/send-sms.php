    ...
    <div class="row">
        <div class="col-md-11 col-lg-offset-0">
            <div class="well">
                ...
                <div class="row"></div>
                <br><br>
                <legend>Sending massage</legend>
                <div class="row">
                    <form class="form-horizontal col-md-8 col-lg-offset-1">
                        <fieldset>
                            <div class="form-group">
                                <label for="phone-number-id" class="col-lg-2 control-label">No.telp</label>
                                <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                <label for="sms-content-id" class="col-lg-2 control-label">Massage</label>
                                <div class="col-lg-10">
